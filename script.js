...
async function showWeather() {
	let queryURL = `https://api.openweathermap.org/data/2.5/weather?q=${cityInput}&units=imperial&appid=d3b85d453bf90d469c82e650a0a3da26`;
...
async function showFiveDayForecast() {
	let queryURL =
		`https://api.openweathermap.org/data/2.5/forecast?q=${cityInput}&units=imperial&appid=d3b85d453bf90d469c82e650a0a3da26`;
